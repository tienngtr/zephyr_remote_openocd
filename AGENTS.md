...
Follow [`docs/development/testing.md`](docs/development/testing.md) for the canonical test-design and regression-value guidance, including use of real production objects, constrained test doubles, deterministic synchronization, and treating excessive test difficulty as a production-design signal.

...
"""Release-only benchmark for remote_openocd startup overhead.
...
def run_benchmark(args: argparse.Namespace) -> dict[str, object]:
    ...
    remote_command = [*common, "-r", "remote_openocd"]
    ...
    result = {
        ...
        "remote": {"runner": "remote_openocd", "statistics": summarize(remote)},
        "overhead": {

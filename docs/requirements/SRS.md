...
Invalid service configuration SHALL be rejected by both client and helper
before process startup. The exact Protocol v1 request fields and validation
rules are defined in [`protocol.md`](../architecture/protocol.md).

...
| AC-DEBUG-001 | Both | `TestZephyrIntegration.test_recording_commands_receive_runner_config_without_io`; `TestRealOpenOcdDebug.test_debug` (load, continue, configured breakpoint, PC/instruction inspection, detach), `test_attach`, and `test_debugserver` |

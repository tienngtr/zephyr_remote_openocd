...
| AC-LIFE-002 | Automated | `TestRealProcessHelper.test_controller_eof_cleans_child_and_workspace`; `TestSshTransportIntegration.test_controller_ssh_loss_cleans_fake_session` |

...
| AC-LIFE-001 | Automated | [`TestRealProcessHelper.test_backend_returns_child_status_and_relays_output`](../../tests/local_integration/test_remote_process.py); [`TestSshTransportIntegration.test_protocol_v1_helper_vertical_slice`](../../tests/ssh_integration/test_ssh_integration.py) |
...
| AC-LIFE-003 | Automated | [`test_operation_failure_precedence`](../../tests/zephyr_integration/test_adapter.py); [`test_rtt_cleanup_failure_does_not_replace_observed_openocd_failure`](../../tests/zephyr_integration/test_adapter.py); [`test_background_openocd_result_does_not_replace_foreground_failure`](../../tests/zephyr_integration/test_adapter.py) |
| AC-LIFE-004 | Automated | [`test_operation_failure_precedence`](../../tests/zephyr_integration/test_adapter.py); [`test_close_attempts_all_cleanup_once_and_preserves_first_failure`](../../tests/unit/test_backend.py) |
